...
public interface IHiveFile {
    ...
    CompletableFuture<Void> putFileFromBuffer(String filename , byte[] data, int length , boolean encrypt);
    ...
    CompletableFuture<Void> putValue(String key , byte[] value , int length , boolean encrypt);
    CompletableFuture<Void> setValue(String key , byte[] value , int length , boolean encrypt);
